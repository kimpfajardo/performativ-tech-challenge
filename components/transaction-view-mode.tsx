...
export const TransactionField = ({
  ...
  return (
    <div className="grid md:grid-cols-2 md:gap-4 py-2 md:grid-rows-1 grid-rows-2">
...
export const TransactionViewMode = ({
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex sm:flex-row flex-col items-start gap-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-2 w-full">
            <div>
              <h4 className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-black">
          ...
          {settlementDate && (
            <AlertDescription>
              <p className="flex gap-1">
                <span className="md:block hidden"> Settlement date: </span>{" "}
        ...
        {transaction?.comments && (
          <Box>
            <div className="space-y-4">
              <h6 className="text-slate-400 font-bold text-sm">Comments</h6>
      ...
      <DialogFooter className="border-t-2 pt-4 mt-4">
        <Button
